                                                                                    ...
                                                                                    <table class="button" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate;">
                                                                                        ...
                                                                                        <tr class="button-tr">
                                                                                            <td class="button-td" valign="middle" style="border-radius: 0px 0px 0px 0px;background-color: #000000;padding: 14px 18px 14px 18px;mso-padding-left-alt: 0; margin-left: 18px;height:24px;">
                                                                                                <a class="pc-font-alt" style="display: inline-block;text-decoration: none;font-family: 'Georgia', Helvetica, Arial, sans-serif;font-weight: normal;font-size: 16px;line-height: 24px;letter-spacing: -0.2px;color: #ffffff;">Activate</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </th>
